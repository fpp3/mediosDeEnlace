  ...
  \section{Actividades}
    \begin{enumerate}
      \item Conectar el generador a la frecuencia de trabajo $f = 410 MHz$.
         Primero configuramos el generador a la frecuencia de trabajo especificada por la consigna.
      ...
      \item Conectar la impedancia de carga $Z_L$ al vatímetro.
        ...
        Luego de verificar que la potencia entregada por el generador es 0\,W, conectamos la carga $Z_1$.
      ...
      \item Medir la potencia incidente $P_i$  y la potencia reflejada $P_r$.
        ...
        Procedemos a medir potencia incidente y reflejada en la carga sin adaptación.
      ...
      \item Calcular el coeficiente de reflexión $\Gamma$ y la Relación de Onda Estacionaria ROE sin ningún stub (ss) conectado a la línea de transmisión.
        ...
        A partir de los datos anteriores calculamos el coeficiente de reflexión y la relación de onda estacionaria (ROE) sin \emph{stub} conectado a la línea:
      ...
      \item Medir la potencia incidente $P_i$  y la potencia reflejada $P_r$.
        ...
        Luego, con un conector BNC en T, adaptamos la línea de transmisión mediante un \emph{stub} en circuito abierto.
